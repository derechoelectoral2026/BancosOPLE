...
//  Versión: 1.3
//  Total: 142 preguntas · 15 subáreas · opción múltiple (3 opciones)
...
//   + 31 reactivos extra v1.3 — OPLE: Área 4 (4.1 y 4.3) y 2.5,
//     con base en la Guía de estudio OPLE del INE)
//
...
//  Constituciones y leyes/códigos electorales locales
//
...
const BANCO_MODULO_C = [
  ...
  // ============================================================
  //  BLOQUE OPLE (v1.3) — Organismos Públicos Locales
  //  31 reactivos · Área 4 (4.1 / 4.3) + 1 reactivo de 2.5
  //  Fuente: Guía de estudio OPLE (INE) · CPEUM Arts. 35, 41, 116
  //  y LGIPE (proceso electoral, paquetes y cómputos)
  // ============================================================

  { sa:"4.1", sal:"Conocimientos fundamentales de los OPL",
    ref:"CPEUM, Art. 35, Fracc. IX, numeral 7°",
    p:null, pt:null,
    q:"¿Quién promueve la participación ciudadana en las entidades federativas?",
    o:["El INE y los Organismos Públicos Locales.",
       "El INE solamente.",
       "Los Organismos Públicos Locales solamente."],
    c:0,
    ex:"Conforme al Art. 35, Fracc. IX, numeral 7° de la CPEUM, el INE y los Organismos Públicos Locales son los encargados de promover la participación ciudadana y su difusión. Dicha promoción debe ser objetiva, imparcial y con fines informativos." },

  { sa:"4.1", sal:"Conocimientos fundamentales de los OPL",
    ref:"CPEUM, Art. 41, Apartado C",
    p:null, pt:null,
    q:"En las consultas populares y los procesos de revocación de mandato, ¿a quién corresponde la organización en el ámbito de las entidades federativas?",
    o:["Al INE solamente.",
       "A la Suprema Corte de Justicia de la Nación.",
       "A los Organismos Públicos Locales."],
    c:2,
    ex:"En el ámbito local corresponde a los OPLE la organización, desarrollo, cómputo y declaración de resultados de los mecanismos de participación ciudadana previstos en la legislación local, además de conteos rápidos y encuestas, de conformidad con el Art. 41, Apartado C de la CPEUM. El INE mantiene la dirección general de estos instrumentos." },

  { sa:"4.1", sal:"Conocimientos fundamentales de los OPL",
    ref:"CPEUM, Art. 41, Apartado C",
    p:"Materia de competencia:\n1. Preparación de la jornada electoral\n2. Resultados e información electoral\n3. Participación ciudadana\n\nActividad / Alcance:\na) Organización, desarrollo, cómputo y declaración de resultados en los mecanismos contemplados en la legislación local.\nb) Impresión de documentos y producción de materiales electorales.\nc) Conteos rápidos, encuestas o sondeos de opinión, observación electoral y resultados preliminares.",
    pt:"Relaciona la materia de competencia con la actividad de los OPLE",
    q:"¿Cuál es la relación correcta entre la materia de competencia y la actividad/alcance de los OPLE?",
    o:["1a, 2c, 3b",
       "1b, 2c, 3a",
       "1b, 2a, 3d"],
    c:1,
    ex:"La relación correcta es 1b, 2c, 3a: la preparación de la jornada implica la impresión de documentos y producción de materiales (b); los resultados e información electoral incluyen conteos rápidos, encuestas y resultados preliminares (c); y la participación ciudadana comprende la organización, desarrollo y cómputo de los mecanismos previstos en la legislación local (a). Fundamento: Art. 41, Apartado C de la CPEUM." },

  { sa:"4.1", sal:"Conocimientos fundamentales de los OPL",
    ref:"CPEUM, Art. 41, Apartado C",
    p:"Funciones de los OPLE a lo largo del proceso electoral local:\n1. Cómputo de la elección del titular del Poder Ejecutivo local\n2. Impresión de documentos y producción de materiales electorales\n3. Escrutinios y cómputos en los términos que señale la ley\n4. Publicación de resultados preliminares y ejecución de conteos rápidos\n5. Declaración de validez y otorgamiento de constancias de mayoría en las elecciones locales",
    pt:"Secuencia cronológica de las funciones de los OPLE",
    q:"¿Cuál es la secuencia cronológica de las funciones que realizan los OPLE a lo largo de las etapas del proceso electoral local, conforme al Art. 41 constitucional?",
    o:["2, 4, 3, 1, 5",
       "4, 2, 1, 3, 5",
       "2, 3, 4, 5, 1"],
    c:0,
    ex:"La secuencia correcta es 2, 4, 3, 1, 5: primero la impresión de boletas y materiales (2), previos a la elección; luego la operación del PREP y conteos rápidos al término de la votación (4); después los escrutinios y cómputos distritales/municipales (3); enseguida el cómputo de la elección a la Gubernatura o Jefatura de Gobierno (1); y finalmente la declaratoria de validez y entrega de constancias de mayoría (5). Fundamento: Art. 41, Apartado C de la CPEUM." },

  { sa:"2.5", sal:"Candidaturas independientes",
    ref:"LGIPE (2024), Arts. 366–371 — apoyo ciudadano",
    p:null, pt:null,
    q:"¿Qué es necesario para conseguir el registro de una candidatura independiente?",
    o:["Cumplir con los requisitos establecidos en la ley electoral, como la obtención del porcentaje de firmas de apoyo ciudadano.",
       "Contar con el respaldo de al menos un partido político.",
       "Pagar una cuota de registro al INE."],
    c:0,
    ex:"El registro de una candidatura independiente exige cumplir los requisitos legales, entre ellos obtener el porcentaje de apoyo ciudadano (respaldo de la ciudadanía) previsto en la ley. No requiere el respaldo de un partido político —de hecho es incompatible con él— ni el pago de cuota alguna al INE. Fundamento: LGIPE, Arts. 366 a 371." },

  { sa:"4.3", sal:"Proceso electoral",
    ref:"LGIPE (2024), Art. 225 / legislación electoral local",
    p:null, pt:null,
    q:"¿Cuál es la última etapa del proceso electoral local?",
    o:["Jornada Electoral.",
       "Resultados y declaraciones de validez de las elecciones.",
       "Dictamen y declaraciones de validez de la elección."],
    c:2,
    ex:"El proceso electoral se compone de las etapas de preparación, jornada electoral, resultados y declaraciones de validez, y —como última etapa— el dictamen y declaraciones de validez de la elección. Fundamento: Art. 225 de la LGIPE y legislación local aplicable." },

  { sa:"4.3", sal:"Proceso electoral",
    ref:"LGIPE (2024), Art. 225, numeral 4",
    p:null, pt:null,
    q:"¿Cuándo concluye la Jornada Electoral en el proceso electoral local?",
    o:["A las 18:00 horas.",
       "Con el cierre de los colegios electorales.",
       "Con la clausura de las casillas."],
    c:2,
    ex:"La Jornada Electoral inicia con la instalación de las casillas y concluye con su clausura, no a una hora fija ni con el cierre de colegios electorales. Fundamento: Art. 225, numeral 4 de la LGIPE." },

  { sa:"4.3", sal:"Proceso electoral",
    ref:"LGIPE (2024), Art. 225, numeral 5",
    p:null, pt:null,
    q:"¿Qué etapa del proceso electoral local involucra la remisión de la documentación y expedientes electorales de las casillas a los consejos distritales y municipales?",
    o:["Jornada Electoral.",
       "Resultados y declaraciones de validez de las elecciones.",
       "Dictamen y declaraciones de validez de la elección."],
    c:1,
    ex:"La etapa de resultados y declaraciones de validez de las elecciones comprende la entrega y recepción de la documentación y expedientes electorales de las casillas en los consejos distritales y municipales, los cómputos y las declaraciones de validez. Fundamento: Art. 225, numeral 5 de la LGIPE." },

  { sa:"4.3", sal:"Proceso electoral",
    ref:"LGIPE (2024), Art. 225, numeral 6",
    p:null, pt:null,
    q:"¿Cuándo inicia la etapa de Dictamen y declaraciones de validez de la elección?",
    o:["Al concluir la Jornada Electoral.",
       "Al recibir la Constancia de Registro de las candidaturas.",
       "Al resolverse el último de los medios de impugnación interpuestos contra las elecciones."],
    c:2,
    ex:"La etapa de dictamen y declaraciones de validez inicia al resolverse el último de los medios de impugnación que se hubieren interpuesto contra la elección, o cuando se tenga constancia de que no se presentó ninguno. Fundamento: Art. 225, numeral 6 de la LGIPE." },

  { sa:"4.3", sal:"Proceso electoral",
    ref:"Legislación electoral local / Tribunal Electoral local",
    p:null, pt:null,
    q:"¿Quién entrega el dictamen que contiene el cómputo final y la declaración de validez de la elección en el proceso electoral local?",
    o:["El Congreso del Estado.",
       "El Organismo Público Local Electoral (OPLE).",
       "El Tribunal Electoral del Estado."],
    c:2,
    ex:"En el proceso electoral local, el Tribunal Electoral del Estado es la autoridad que, una vez resueltas las impugnaciones, formula el dictamen con el cómputo final y la declaración de validez de la elección (particularmente en la elección de la titularidad del Ejecutivo local)." },

  { sa:"4.3", sal:"Proceso electoral",
    ref:"CPEUM, Art. 116 / legislación electoral local",
    p:null, pt:null,
    q:"¿Cuál es el objetivo principal del proceso electoral local?",
    o:["Renovar periódicamente a los integrantes de los Poderes Legislativo, Ejecutivo y de los Ayuntamientos de la entidad.",
       "Determinar la fecha de las elecciones federales.",
       "Realizar una consulta ciudadana."],
    c:0,
    ex:"El proceso electoral local tiene por objeto renovar periódicamente a los integrantes de los Poderes Legislativo y Ejecutivo de la entidad y de los Ayuntamientos, conforme al Art. 116 de la CPEUM y la legislación electoral local." },

  { sa:"4.3", sal:"Proceso electoral",
    ref:"Constituciones y leyes electorales locales",
    p:null, pt:null,
    q:"¿Qué órgano emite la convocatoria para el proceso electoral local?",
    o:["El Tribunal Electoral del Estado.",
       "El Instituto Nacional Electoral (INE).",
       "El Congreso del Estado."],
    c:2,
    ex:"La convocatoria para el proceso electoral local es emitida por el Congreso del Estado, conforme a la constitución y las leyes electorales de cada entidad federativa." },

  { sa:"4.3", sal:"Proceso electoral",
    ref:"LGIPE (2024), Art. 225, numeral 4",
    p:null, pt:null,
    q:"¿Cuál es el último momento de la Jornada Electoral?",
    o:["Votación.",
       "Escrutinio y cómputo de los votos.",
       "Integración de los expedientes de casilla y paquetes electorales."],
    c:2,
    ex:"Dentro de la Jornada Electoral, el último momento es la integración de los expedientes de casilla y de los paquetes electorales, tras la votación, el escrutinio y el cómputo. Fundamento: Art. 225, numeral 4 de la LGIPE." },

  { sa:"4.3", sal:"Proceso electoral",
    ref:"LGIPE (2024), Art. 83 — atribuciones de la Presidencia de casilla",
    p:null, pt:null,
    q:"¿Cuál es el papel de la Presidencia de Casilla en la Jornada Electoral?",
    o:["Mantener el orden en la Mesa Directiva de Casilla.",
       "Contar los votos por sí sola.",
       "Fiscalizar a los partidos políticos."],
    c:0,
    ex:"Entre las atribuciones de la Presidencia de la Mesa Directiva de Casilla está mantener el orden, asegurar el libre acceso de electores y garantizar el secreto del voto. El escrutinio y cómputo es una función colegiada de la mesa, y la fiscalización corresponde a otras autoridades. Fundamento: Art. 83 de la LGIPE." },

  { sa:"4.3", sal:"Proceso electoral",
    ref:"LGIPE (2024), Arts. 299 y 300",
    p:null, pt:null,
    q:"¿Qué sucede con los paquetes electorales después de la Jornada Electoral?",
    o:["Se entregan a la Presidencia de la Mesa Directiva de Casilla.",
       "Se envían directamente a la Presidencia Municipal.",
       "Se entregan a los Consejos Electorales correspondientes."],
    c:2,
    ex:"Concluida la jornada y el escrutinio en la casilla, los paquetes electorales se entregan a los Consejos Distritales o Municipales correspondientes. Fundamento: Arts. 299 y 300 de la LGIPE." },

  { sa:"4.3", sal:"Proceso electoral",
    ref:"LGIPE (2024), Art. 298",
    p:null, pt:null,
    q:"¿Qué elementos conforman un paquete electoral?",
    o:["Únicamente actas levantadas y boletas utilizadas.",
       "Listas de candidatos y propaganda electoral.",
       "Actas levantadas, boletas utilizadas e inutilizadas, lista nominal y escritos de protesta."],
    c:2,
    ex:"El paquete electoral contiene el expediente de casilla (actas), las boletas utilizadas e inutilizadas, los votos válidos y nulos, la lista nominal de electores y las reclamaciones o escritos de protesta presentados. Fundamento: Art. 298 de la LGIPE." },

  { sa:"4.3", sal:"Proceso electoral",
    ref:"LGIPE (2024), Arts. 302 y 303",
    p:null, pt:null,
    q:"¿En qué orden se deben recibir los paquetes electorales en los Consejos Distritales y Municipales?",
    o:["Al azar.",
       "En orden de llegada (cronológico).",
       "De acuerdo con la cantidad de votos emitidos."],
    c:1,
    ex:"Los Consejos Electorales reciben los paquetes electorales de manera continua, registrando la recepción de forma cronológica conforme van arribando a la sede. Fundamento: Arts. 302 y 303 de la LGIPE." },

  { sa:"4.3", sal:"Proceso electoral",
    ref:"LGIPE (2024), Art. 303, numeral 1",
    p:null, pt:null,
    q:"¿Quién recibe los paquetes electorales en los Consejos Electorales?",
    o:["Los representantes de los partidos políticos.",
       "La Secretaría del Consejo.",
       "La Presidencia de la Mesa Directiva de Casilla."],
    c:1,
    ex:"La Presidencia y la Secretaría del Consejo, con el auxilio del personal autorizado, son las instancias facultadas para la recepción formal de los paquetes electorales y la expedición del recibo correspondiente. Fundamento: Art. 303, numeral 1 de la LGIPE." },

  { sa:"4.3", sal:"Proceso electoral",
    ref:"LGIPE (2024), Art. 303, numeral 1, inciso d)",
    p:null, pt:null,
    q:"¿Qué se hace con el sobre adherido al paquete electoral una vez que se recibe en el Consejo?",
    o:["Se desprende de inmediato.",
       "Se envía a la Presidencia Municipal.",
       "Se entrega a los candidatos independientes."],
    c:0,
    ex:"El sobre adherido por fuera del paquete contiene una copia del acta de escrutinio y cómputo; al recibir el paquete, dicho sobre se desprende de inmediato para dar paso al registro preliminar de resultados. Fundamento: Art. 303, numeral 1, inciso d) de la LGIPE." },

  { sa:"4.3", sal:"Proceso electoral",
    ref:"LGIPE (2024), Art. 303, numeral 1, inciso e)",
    p:null, pt:null,
    q:"¿Qué información se anota en las formas una vez que se desprende el sobre adherido al paquete electoral?",
    o:["Los nombres de los votantes.",
       "Los resultados de la votación.",
       "Los nombres de los candidatos independientes."],
    c:1,
    ex:"Con los datos del acta contenida en el sobre exterior se capturan y anotan los resultados consignados de la votación en los registros o sistemas del Consejo. Fundamento: Art. 303, numeral 1, inciso e) de la LGIPE." },

  { sa:"4.3", sal:"Proceso electoral",
    ref:"LGIPE (2024), Art. 303, numeral 1, inciso f)",
    p:null, pt:null,
    q:"¿Qué sucede con los paquetes electorales una vez que se trasladan a la bodega electoral?",
    o:["Se queman para garantizar la confidencialidad.",
       "Se mantienen resguardados hasta el cómputo correspondiente.",
       "Se entregan a los representantes de los partidos políticos."],
    c:1,
    ex:"Tras su recepción, los paquetes son depositados en la bodega electoral bajo custodia estricta hasta el inicio formal de las sesiones de cómputo oficial. Fundamento: Art. 303, numeral 1, inciso f) de la LGIPE." },

  { sa:"4.3", sal:"Proceso electoral",
    ref:"LGIPE (2024), Art. 310, numeral 1 y REINE",
    p:null, pt:null,
    q:"¿Cuándo se lleva a cabo la reunión previa con representantes de partidos políticos para determinar los paquetes electorales a someter al recuento de votos?",
    o:["El día de la Jornada Electoral.",
       "El día posterior al cómputo distrital.",
       "El martes anterior al día del cómputo distrital o municipal."],
    c:2,
    ex:"El martes previo a la sesión de cómputos, la Presidencia del Consejo convoca a una reunión de trabajo con las representaciones partidistas para examinar las actas e identificar qué paquetes deberán ser recontados. Fundamento: Art. 310, numeral 1 de la LGIPE y Reglamento de Elecciones del INE." },

  { sa:"4.3", sal:"Proceso electoral",
    ref:"LGIPE (2024), Art. 310, numerales 1 y 2",
    p:null, pt:null,
    q:"¿Quién aprueba los acuerdos tomados en la reunión previa con representantes de partidos políticos?",
    o:["La Presidencia de la Mesa Directiva de Casilla.",
       "El personal autorizado por el Consejo Electoral.",
       "La Presidencia del Consejo Electoral."],
    c:2,
    ex:"La Presidencia del Consejo somete a aprobación del pleno u órgano colegiado los acuerdos de trabajo de cara a la sesión oficial de cómputo. Fundamento: Art. 310, numerales 1 y 2 de la LGIPE." },

  { sa:"4.3", sal:"Proceso electoral",
    ref:"LGIPE (2024), Art. 303, numeral 1, inciso f) y REINE",
    p:null, pt:null,
    q:"¿Cuál es el propósito de sellar la bodega electoral en presencia de representantes de partidos políticos?",
    o:["Evitar que se abran los paquetes electorales.",
       "Garantizar que los paquetes sean almacenados de manera segura.",
       "Realizar el recuento de votos."],
    c:1,
    ex:"La colocación de fajas de sellado firmadas por consejeros y representantes partidistas en los accesos a la bodega busca garantizar el almacenamiento seguro, la cadena de custodia y la inviolabilidad de la documentación electoral. Fundamento: Art. 303, numeral 1, inciso f) de la LGIPE y Reglamento de Elecciones del INE." },

  { sa:"4.3", sal:"Proceso electoral",
    ref:"LGIPE (2024), Arts. 299 y 300",
    p:null, pt:null,
    q:"¿Quién traslada los paquetes electorales a los Consejos Electorales correspondientes?",
    o:["Los votantes.",
       "La Presidencia de la Mesa Directiva de Casilla.",
       "El personal autorizado por el Consejo Electoral."],
    c:2,
    ex:"El traslado de los paquetes se realiza bajo la responsabilidad de la presidencia de casilla o mediante los mecanismos de recolección aprobados por el Consejo Electoral, operados por personal capacitado y autorizado (como los CAE). Fundamento: Arts. 299 y 300 de la LGIPE." },

  { sa:"4.3", sal:"Proceso electoral",
    ref:"LGIPE (2024), Art. 298",
    p:null, pt:null,
    q:"¿Qué se incluye en el paquete electoral de las elecciones de Diputaciones Locales?",
    o:["Actas levantadas y boletas utilizadas.",
       "Lista nominal de electores y resultados del PREP.",
       "Listas de candidatos y propaganda electoral."],
    c:0,
    ex:"El paquete electoral contiene el expediente de la casilla con las actas oficiales (jornada, escrutinio y cómputo) y los sobres con las boletas utilizadas (votos válidos y nulos), así como las inutilizadas. Fundamento: Art. 298 de la LGIPE." },

  { sa:"4.3", sal:"Proceso electoral",
    ref:"LGIPE (2024), Art. 303, numeral 1, inciso f)",
    p:null, pt:null,
    q:"¿Qué se hace con el paquete electoral una vez que es sellado en la bodega electoral?",
    o:["Se abre para revisión de los resultados.",
       "Se almacena en un lugar seguro hasta el cómputo correspondiente.",
       "Se entrega a la Presidencia de la Mesa Directiva de Casilla."],
    c:1,
    ex:"Tras ingresar a la bodega y colocarse los sellos correspondientes, los paquetes permanecen cerrados y bajo resguardo hasta el inicio de la sesión oficial de cómputo. Fundamento: Art. 303, numeral 1, inciso f) de la LGIPE." },

  { sa:"4.3", sal:"Proceso electoral",
    ref:"LGIPE (2024), Art. 310, numeral 1 y REINE",
    p:null, pt:null,
    q:"¿Cuál es el propósito de la reunión previa con representantes de partidos políticos?",
    o:["Determinar el ganador de la elección.",
       "Discutir los resultados del PREP.",
       "Acordar cuáles paquetes electorales se someterán al recuento de votos."],
    c:2,
    ex:"La reunión de trabajo previa permite examinar las copias de las actas de casilla e identificar con antelación los paquetes que encuadran en causales de recuento parcial o total. Fundamento: Art. 310, numeral 1 de la LGIPE y Reglamento de Elecciones del INE." },

  { sa:"4.3", sal:"Proceso electoral",
    ref:"LGIPE (2024), Art. 303, numeral 2",
    p:null, pt:null,
    q:"¿Qué debe incluir el acta circunstanciada de la recepción de paquetes electorales?",
    o:["Los nombres de los votantes y candidatos.",
       "El número de teléfono de la Secretaría del Consejo.",
       "La hora de recepción y el estado de cada paquete electoral."],
    c:2,
    ex:"El Consejo levanta un acta circunstanciada en la que asienta la hora de entrega de cada paquete, el medio de transporte y las condiciones físicas o alteración de sus sellos. Fundamento: Art. 303, numeral 2 de la LGIPE." },

  { sa:"4.3", sal:"Proceso electoral",
    ref:"LGIPE (2024), Art. 303, numeral 1, inciso f)",
    p:null, pt:null,
    q:"¿Cuál es el procedimiento para garantizar la confidencialidad e integridad de los paquetes electorales?",
    o:["Quemarlos en una ceremonia especial.",
       "Sellar la bodega electoral en presencia de representantes de los partidos políticos.",
       "Publicar todos los resultados en línea."],
    c:1,
    ex:"El sellado del acceso a la bodega mediante fajas firmadas por los integrantes del Consejo y las representaciones partidistas garantiza la cadena de custodia e inviolabilidad del paquete electoral. Fundamento: Art. 303, numeral 1, inciso f) de la LGIPE." },

  { sa:"4.3", sal:"Proceso electoral",
    ref:"LGIPE (2024), Art. 303, numeral 1, incisos d) y e)",
    p:null, pt:null,
    q:"¿Quién se encarga de anotar los resultados en las formas después de desprender el sobre adherido al paquete electoral?",
    o:["La Presidencia de la Mesa Directiva de Casilla.",
       "La Secretaría del Consejo.",
       "Los votantes en la Jornada Electoral."],
    c:1,
    ex:"La Secretaría del Consejo, con auxilio del personal técnico, extrae el acta del sobre exterior y captura o anota los resultados consignados para la divulgación preliminar. Fundamento: Art. 303, numeral 1, incisos d) y e) de la LGIPE." }
